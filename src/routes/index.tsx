...
import patientsCommunity from "@/assets/patients-community.png";
import logoAbc01 from "@/assets/logo-abc-01.png";
import logoAbc02 from "@/assets/logo-abc-02.png";
    ...
    <div className="min-h-screen bg-clinic-cream font-sans text-clinic-teal">
      ...
      <nav className="flex justify-between items-center px-6 md:px-12 py-6 md:py-8">
        <a href="#top" className="flex items-center">
          <img src={logoAbc01} alt="ABC Diabetes" className="h-14 md:h-16 w-auto" />
        </a>
      ...
      <main id="top">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <ul className="space-y-5 text-base md:text-lg leading-relaxed">
                {[
                  ...
                  { k: "Consulta presencial", v: "Calle 7 #39-197, Edificio intermedica, Consultorio 1112, Medellín, Antioquia." },
                ].map((item) => (
          ...
          <div className="max-w-[1400px] mx-auto grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-8 grid sm:grid-cols-2 gap-6 md:gap-8">
              ...
              <div className="sm:col-span-2 overflow-hidden rounded-2xl ring-1 ring-clinic-cream/10">
                <img
                  src={patientsCommunity}
                  alt="Tres mujeres descansando en un parque después de hacer ejercicio, representando bienestar y comunidad"
                  width={1440}
                  height={512}
                  loading="lazy"
        ...
        <section id="contact" className="px-6 md:px-12 py-20 md:py-28 text-center">
          ...
          <p className="mt-10 text-clinic-teal/50 text-sm leading-relaxed">
            (+57) 320 681 6213
            <br />
            Calle 7 #39-197, Edificio intermedica, Consultorio 1112, Medellín, Antioquia
          </p>
        </section>
      </main>
      ...
      <footer className="bg-clinic-teal text-clinic-cream px-6 md:px-12 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="text-xs text-clinic-cream/70 text-center md:text-right space-y-1">
          <div className="font-bold text-clinic-cream">ABC Diabetes SAS · NIT 901665498-6</div>
          <div>Calle 7 #39-197 Consultorio 1112, Medellín, Antioquia</div>
